...
// Bx -> nnz -> vals
    ...
    Converter<IDType, NNZType, ValueType>::Converter() {
        this->RegisterConversionFunction(COO<IDType, NNZType, ValueType>::get_format_id_static(),
                                         CSR<IDType, NNZType, ValueType>::get_format_id_static(),
                                         new CooCsrFunctor<IDType, NNZType, ValueType>());
        this->RegisterConversionFunction(CSR<IDType, NNZType, ValueType>::get_format_id_static(),
