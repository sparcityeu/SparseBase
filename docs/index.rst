...
It is designed with HPC usage at the forefront. It is meant as a container of tensors as well as objects composed of
these tensors, e.g. graphs, multi-graphs, and hypergraphs. It mainly focuses on re-ordering, partitioning, and
