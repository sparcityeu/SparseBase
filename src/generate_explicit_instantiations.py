...
gen_inst("TransformPreprocessType<format::FormatOrderTwo<$id_type, $nnz_type, $value_type>, std::vector<format::FormatOrderTwo<$id_type, $nnz_type, $value_type>*>>", "preprocess.inc")
...
gen_inst("MetisGraphPartition<$id_type, $nnz_type, $value_type>", "preprocess.inc", ifdef="USE_METIS")
gen_inst("ApplyGraphPartition<$id_type, $nnz_type, $value_type>", "preprocess.inc")
