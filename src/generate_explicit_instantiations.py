...
class preprocess_init(explicit_initialization):
    ...
    def run(self):
        ...
        print_implementations(['GenericReorder', 'RabbitReorder', 'SlashburnReorder', 'DegreeReorder', 'RCMReorder', 'TransformPreprocessType', 'Transform', 'Degrees'], self.out_stream)
