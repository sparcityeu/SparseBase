...
#ifndef SPARSEBASE_PROJECT_AVG_DEGREE_DISTRIBUTION_H
#define SPARSEBASE_PROJECT_AVG_DEGREE_DISTRIBUTION_H
namespace sparsebase::feature {

//! An empty struct used for the parameters of AvgDegree
struct AvgDegreeParams : utils::Parameters {};
...
class AvgDegree
 ...
 public:
  //! An empty struct used for the parameters of AvgDegree
  typedef AvgDegreeParams ParamsType;
  AvgDegree();
  AvgDegree(AvgDegreeParams);
  AvgDegree(const AvgDegree &);
  AvgDegree(std::shared_ptr<AvgDegreeParams>);
   ...
   */
  FeatureType *GetAvgDegree(format::Format *format,
...
#ifdef _HEADER_ONLY
#include "sparsebase/feature/avg_degree.cc"
#endif
#endif  // SPARSEBASE_PROJECT_AVG_DEGREE_DISTRIBUTION_H
