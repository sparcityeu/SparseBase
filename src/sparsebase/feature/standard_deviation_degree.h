...
#ifndef SPARSEBASE_PROJECT_STANDARD_DEVIATION_DEGREE_DISTRIBUTION_H
#define SPARSEBASE_PROJECT_STANDARD_DEVIATION_DEGREE_DISTRIBUTION_H
namespace sparsebase::feature {

//! An empty struct used for the parameters of StandardDeviationDegree
struct StandardDeviationDegreeParams : utils::Parameters {};
...
class StandardDeviationDegree
    : public feature::FeaturePreprocessType<FeatureType *> {
 public:
  //! An empty struct used for the parameters of StandardDeviationDegree
  typedef StandardDeviationDegreeParams ParamsType;
  StandardDeviationDegree();
  StandardDeviationDegree(StandardDeviationDegreeParams);
  StandardDeviationDegree(const StandardDeviationDegree &);
  StandardDeviationDegree(std::shared_ptr<StandardDeviationDegreeParams>);
   ...
   */
  FeatureType *GetStandardDeviationDegree(format::Format *format,
   ...
   */
  FeatureType *GetStandardDeviationDegree(
  ...
  static FeatureType
      *
      //! Standard deviation degree generation implementation function for CSRs
      /*!
       *
       * @param format a single format pointer to any format
...
#ifdef _HEADER_ONLY
#include "sparsebase/feature/standard_deviation_degree.cc"
#endif
#endif  // SPARSEBASE_PROJECT_STANDARD_DEVIATION_DEGREE_DISTRIBUTION_H
