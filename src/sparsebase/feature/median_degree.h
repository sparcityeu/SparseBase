...
#ifndef SPARSEBASE_PROJECT_MEDIAN_DEGREE_DISTRIBUTION_H
#define SPARSEBASE_PROJECT_MEDIAN_DEGREE_DISTRIBUTION_H
namespace sparsebase::feature {

//! An empty struct used for the parameters of MedianDegree
struct MedianDegreeParams : utils::Parameters {};
...
class MedianDegree
 ...
 public:
  //! An empty struct used for the parameters of MedianDegree
  typedef MedianDegreeParams ParamsType;
  MedianDegree();
  MedianDegree(MedianDegreeParams);
  MedianDegree(const MedianDegree &);
  MedianDegree(std::shared_ptr<MedianDegreeParams>);
   ...
   */
  FeatureType *GetMedianDegree(format::Format *format,
...
#ifdef _HEADER_ONLY
#include "sparsebase/feature/median_degree.cc"
#endif
#endif  // SPARSEBASE_PROJECT_MEDIAN_DEGREE_DISTRIBUTION_H
