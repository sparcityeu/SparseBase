...
/*!
 *
 * \param data Contains the data needed for the preprocessing. This map is returned by the DataLoader \param fparams Parameters specific to the target file. \param params Preprocessing parameters.
 */
...
/*!
 *
 * \param data Contains the data needed for the preprocessing. This map is returned by the DataLoader and extended by the preprocessing. \param fparams Parameters specific to the target file. \param pparams Parameters specific to the preprocessing. \param kparams Parameters specific to the kernel. \return The results of the kernel. The results are stored in _results.
 */
...
class ExperimentType {
 public:
  ...
  //! Each target will be preprocessed by all the preprocessing functions. Then every kernel will be applied to all of the newly created data. The cartesian product of the number of _targets, _preprocesses and _kernels iterations will be carried out.
  /*!
   *
   * \param times Specifies the number of samples.
   * \param store_auxiliary determines if the auxiliary data created as a by product of the experiments is going to be stored or not.
   */
  ...
  /*!
   *
   * \param id Preprocessing ID is used to store results, runtimes and auxiliary data. \param func The function which follows the PreprocessFunction definition. \param params Parameters to be passed to the respective function.
   */
