...
class ConcreteExperiment : public ExperimentType {
 public:
  ...
  /*!
   *
   * \param id Preprocessing id, used to store results, runtimes and auxiliary
 ...
 protected:
  ...
  //! Stores runtimes.
  //! The identifier is generated as a comma delimited string of
  //! target,preprocess_id, and kernel_id respectively.
