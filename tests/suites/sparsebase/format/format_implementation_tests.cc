...
format::COO<int, int, int> g_coo(4, 4, 4, coo_row, coo_col,
                                 coo_vals);
...
conv->RegisterConversionFunction(format::CSR<int, int, int>::get_id_static(), format::COO<int, int, int>::get_id_static(), dummy_conversion, [](context::Context*, context::Context*){ return true;});
format::CSR<int, int, int> csr(4, 4, csr_row_ptr, csr_col,
                               csr_vals);
