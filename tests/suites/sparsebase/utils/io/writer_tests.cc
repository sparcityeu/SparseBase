...
TEST(BinaryOrderTwoWriter, COO){
  ...
  sparsebase::utils::io::BinaryWriterOrderTwo<int,int,float> writerOrderTwo("writer_test_order_two_coo.bin");
  writerOrderTwo.WriteCOO(&coo);

  // Read the COO from the binary file with sparsebase
  sparsebase::utils::io::BinaryReaderOrderTwo<int,int,float> readerOrderTwo("writer_test_order_two_coo.bin");
...
TEST(BinaryOrderTwoWriter, CSR){
  ...
  // Write the COO to a binary file with sparsebase
  sparsebase::utils::io::BinaryWriterOrderTwo<int,int,float> writerOrderTwo("writer_test_order_two_csr.bin");
  writerOrderTwo.WriteCSR(&csr);

  // Read the COO from the binary file with sparsebase
  sparsebase::utils::io::BinaryReaderOrderTwo<int,int,float> readerOrderTwo("writer_test_order_two_csr.bin");
