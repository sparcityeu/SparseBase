...
int main(int argc, char * argv[]){
  ...
  Graph<unsigned int, unsigned int> g2(new UedgelistReader<unsigned int, unsigned int, void>("graphs/com-dblp_c.graph"));
  ...
  //unsigned int * order = orderer.get_order<void>(g2.get_connectivity());
