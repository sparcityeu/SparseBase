...
// this kernel counts the number of nnz in each row of the matrix or number of rows of a graph
...
int main(int argc, char **argv){
  ...
  // experiment functions are wrapped with std::function, thus can be any callable function that abides by the function definition.
  // even though passing file names as a target makes perfect sense, this example lambda shows anything can be passed as a context to experiment all functions
